...
export default function Home() {
  ...
  const handleAction = async (selectedMode: Mode) => {
    ...
    if (!trimmed) { setErrMsg("Paste a YouTube link first."); setState("error"); return; }
    if (!isValidYT(trimmed)) { setErrMsg("That doesn't look like a YouTube URL."); setState("error"); return; }
    ...
    try {
      ...
      setInfo({ ...data, isPlaylist: selectedMode === "playlist" ? data.isPlaylist : false });
      setState("ready");
    } catch (e) {
            ...
            <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <linearGradient id="lg" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
                  <stop stopColor="#FF4B4B" /><stop offset="1" stopColor="#C0000F" />
                </linearGradient>
              </defs>
            </svg>
          </div>
